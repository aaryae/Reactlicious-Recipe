    ...
    <div className="feature-ones">
      <div className="firstbox">
        <div className="image">
          ...
          <button>
            <a href="/recipes"> Check the recipe </a>
            <i class="fa-solid fa-arrow-down " style={{ color: "#000000" }}></i>
          </button>
        </div>
        <div className="image">
          <img
            className="hover:blur-[2px] hover:border-solid-red-2px"
            src={pizza}
            alt=""
          />
          <button>
      ...
      <div className="midbox">
        <h1 className="text-[#FFA500] text-2xl tass">
          Welcome to our Reactlicious Website,
        </h1>
        <br />
        <br />
        ...
        <p className="hov">
          {" "}
          We believe in the best , So here are some of the best for you{" "}
          ...
          <div className="news">
            <div className="boxes">
              ...
              <a href="/news">
                {" "}
                <p>
                  The Secret Ingredient That Gives Brie Larson's Christmas
                  Chicken Recipe Ultra-Crispy Skin
                </p>
              </a>
            </div>
            <div className="boxes">
              ...
              <a href="/news">
                <p>
                  Meet Texas Yum Yum: The Easiest No-Bake Pie You’ll Ever Make
                </p>
              </a>
            </div>
            <div className="boxes">
              ...
              <a href="/news">
                <p>
                  The Most Adorable Gingerbread House Kit Is Only $9 but Won’t
                  Last Long
                </p>
              </a>
            </div>
            <div className="boxes">
              ...
              <a href="/news">
                <p>
                  Finally, Our Best Recipes From Over 25 Years Are Coming
